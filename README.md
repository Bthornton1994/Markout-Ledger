...
```bash
npm install
git config core.hooksPath .githooks   # optional: the opt-in, bypassable A10 pre-push check (docs/M2_DATA_CONTRACT.md section 6.5)
