...
docs/           schema, accounting, execution model, controller contract, replay guide, data requirements, release prep, deployment and rollback requirements
```
...
- [docs/RELEASE_PREP.md](docs/RELEASE_PREP.md): recorded commits on `main` through the pull request #5 merge, the offline CI and Node replay path, and the owner decisions still required. C2, C3, and C5 remain unmet.
- [docs/DEPLOYMENT_ROLLBACK.md](docs/DEPLOYMENT_ROLLBACK.md): production deployment and rollback requirements. The target fields are blank. C2, C3, and C5 remain unmet.
