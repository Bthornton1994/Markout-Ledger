...
docs/           schema, accounting, execution model, controller contract, replay guide, data requirements, release prep
```
...
- [docs/RELEASE_PREP.md](docs/RELEASE_PREP.md): post-merge verify of `main`, the offline CI and Node replay path, and the owner decisions still required. C2, C3, and C5 remain unmet.
